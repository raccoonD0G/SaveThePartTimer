...
public class CountDown : MonoBehaviour
{
    ...
    public void Init()
    {
        ...
        string stageStr = Managers.s_managersProperty.stageNameStrProperty;
        Debug.Log(stageStr);
        if (stageStr == "stage 1" || stageStr == "stage 2" || stageStr == "stage 3")
        {
            time = 60.0f;
        }

        StartCoroutine(Timer(time));//제한시간 바꾸고 싶으면 time 대신 숫자 집어넣기
    }
    void Start()
    {
        Init();
